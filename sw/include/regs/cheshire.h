...
// Integer clock selector/divider for axi2hdmi
#define CHESHIRE_AXI2HDMI_CLOCK_CONFIG_REG_OFFSET 0x60
#define CHESHIRE_AXI2HDMI_CLOCK_CONFIG_DIVIDER_MASK 0xff
#define CHESHIRE_AXI2HDMI_CLOCK_CONFIG_DIVIDER_OFFSET 0
#define CHESHIRE_AXI2HDMI_CLOCK_CONFIG_DIVIDER_FIELD \
  ((bitfield_field32_t) { .mask = CHESHIRE_AXI2HDMI_CLOCK_CONFIG_DIVIDER_MASK, .index = CHESHIRE_AXI2HDMI_CLOCK_CONFIG_DIVIDER_OFFSET })
#define CHESHIRE_AXI2HDMI_CLOCK_CONFIG_SELECTOR_BIT 8
